...
def boolean_difference(ax: AxiomContext, input: BooleanInput) -> BooleanOutput:
    """Compute the boolean difference (a MINUS b) of two meshes, via the
    ...
    result = boolean.difference([mesh_a, mesh_b], engine="manifold")
